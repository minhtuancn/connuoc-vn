...
CREATE UNIQUE INDEX gauge_reach_links_current_station_reach_uniq
  ON gauge_reach_links (station_id, river_reach_id)
  WHERE effective_to IS NULL;
CREATE INDEX gauge_reach_links_reach_idx
  ON gauge_reach_links (river_reach_id, confidence DESC);
